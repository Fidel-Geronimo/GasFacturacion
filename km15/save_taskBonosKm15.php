...
if (isset($_GET["id"])) {
  ...
  if ($id == 1) {
    ...
    $query = "INSERT INTO bonoskm15(nombre, valor, abono, deuda,credito,comentario,idCliente) VALUES('$nombre','$valor','$abono', '$deuda', '$credito','$comentario,','$idCliente')";
...
<div class="container p-4 shadow editwidth">
  <div class="col-md-8 mx-auto">
    <div class="card_body">
      <form action="validacionBonosKm15.php?id=1" method="post">
