        ...
        Swal
            ...
            .then(resultado => {
                if (resultado.value) {
                    ...
                    // Hicieron click en "Sí"
                    window.location = "https://wa.me/1<?php echo $telefonoClientePago ?>?text=*MENSAJE%20AUTOMATICO%20GUAYO*%0AMensaje%20Dirigido%20A:%20<?php echo $nombreClientePago ?>%0A%0A*FACTURA%20PAGADA EXITOSAMENTE!*%0AGracias%20por%20realizar%20el%20pago%20de%20su%20*bono*%20de%20Gas%0ARecuerde%20pagar%20a%20tiempo%20para%20mantener%20su%20credito%20*vigente*!%0A%0A*GRACIAS%20POR%20PREFERIRNOS*";
...
<!--  -->
<h1 class="text-center">BONOS KM15</h1>
    ...
    <div class="row">
        ...
        if (isset($_SESSION["revertir"])) { ?>
            ...
            <div class="alert alert-primary d-flex align-items-center" role="alert">
                ...
                <div>
                    <button type="button" class="btn" onclick="window.location.href='revertirBonosKm15.php'"><i class="fas fa-sync-alt"></i> Revertir</button>
        ...
        <button type="button" onclick="location.href='save_taskBonosKm15.php?id=0'" class="btn btn-primary btn-lg edicionButton"><i class="fas fa-plus"></i> Nueva Factura</button>
        <!--  -->
                    ...
                    while ($row = mysqli_fetch_array($result_facturacion)) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <p>
                                    <a href="edit-bonosKm15.php?id=<?php echo $row['ID'] ?>" class="btn btn-secondary botonesOpciones">Editar <i class="fas fa-edit"></i></a>
                                ...
                                <div class="collapse" id="<?php echo $azul ?>">
                                    <div class="card card-body">
                                        <a href="abono-bonosKm15.php?id=<?php echo $row['ID'] ?>" class="btn btn-info botonesOpciones text-white">Abonar</a>
                                        <a class="btn btn-warning botonesOpciones text-white" onclick="confirmacionReenvioBonosKm15(<?php echo $row['idCliente'] ?>)">Factura</a>
                                        <a class="btn btn-danger botonesOpciones" onclick="confirmacionBonosKm15(<?php echo $row['ID'] ?>)">Eliminar</a>
                                        <a class="btn btn-success botonesOpciones" onclick="confirmacionPagoBonoKm15(<?php echo $row['ID'] ?>)">Pago</a>
                                    </div>
                                </div>
                                <!--  -->
