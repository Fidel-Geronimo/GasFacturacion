...
if (isset($_GET["id"])) {
    ...
    $query = "SELECT * FROM gaskm15 WHERE ID = $id";
    ...
    if (isset($_POST["actualizar"])) {
        ...
        <?php
            ...
            if ($nombre == $idCliente) {
                ...
                $query = "UPDATE gaskm15 set nombre = '$nombre', galones= '$galones',precio= '$precio',abono= '$abono',Deuda= '$deuda', comentario = '$comentario' WHERE id = $id";
            ...
            $query = "UPDATE gaskm15 set nombre = '$nombre', galones= '$galones',precio= '$precio',abono= '$abono',Deuda= '$deuda', comentario = '$comentario',idCliente='$idCliente' WHERE id = $id";
            mysqli_query($conn, $query);
            }
...
<div class="container p-4 shadow editwidth">
    <div class="col-md-8 mx-auto">
        <div class="card_body">
            <form action="editkm15.php?id=<?php echo $_GET["id"]; ?>" method="post">
