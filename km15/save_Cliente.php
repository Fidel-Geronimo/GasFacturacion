...
if (isset($_POST['boton'])) {
  if ($_POST['nombre'] == "" || $_POST['telefono'] == "" || $_POST['direccion'] == "") { ?>
    ...
    // confirmacion de duplicidad del cliente/////////////////
    $queriConfirmacion = "SELECT * from clientekm15 where telefono = $telefono";
    ...
    <?php  } else {
      $queryCliente = "INSERT INTO clientekm15(nombre, telefono, direccion, comentario) VALUES('$nombre','$telefono','$direccion','$comentario')";

      $resultado =  mysqli_query($conn, $queryCliente);
