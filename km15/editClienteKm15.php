...
if (isset($_GET["id"])) {
    ...
    $query = "SELECT * FROM clientekm15 WHERE ID = $id";
    ...
    if (isset($_POST["actualizar"])) {
        ...
        <?php
            ...
            $query = "UPDATE gaskm15 set nombre = '$nombre' WHERE idCliente = $id";
            mysqli_query($conn, $query);

            $query = "UPDATE bonoskm15 set nombre = '$nombre' WHERE idCliente = $id";
            mysqli_query($conn, $query);
            // ===========================================================================

            $query = "UPDATE clientekm15 set nombre = '$nombre', telefono= '$telefono',direccion= '$direccion',comentario= '$comentario' WHERE id = $id";
            mysqli_query($conn, $query);
            $_SESSION['messageEdit'] = 1; ?>
            <script>
                window.location = "clientesKm15.php";
            </script>
<?php
        }
    }
...
<div class="container p-4 shadow editwidth">
    <div class="col-md-8 mx-auto">
        <div class="card_body">
            <form action="editClienteKm15.php?id=<?php echo $_GET["id"]; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="telefono" id="apellido" value="<?php echo $telefono ?>" class="form-control" placeholder="Edita el Telefono">
                </div>
                <div class="form-group">
