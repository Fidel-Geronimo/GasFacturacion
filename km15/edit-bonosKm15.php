...
if (isset($_GET["id"])) {
    ...
    $query = "SELECT * FROM bonoskm15 WHERE ID = $id";
    ...
    if (isset($_POST["actualizarBonos"])) {
        ...
        <?php
            ...
            if ($nombre == $idCliente) {
                ...
                $query = "UPDATE bonoskm15 set nombre = '$nombre',valor= '$valor',abono= '$abono',Deuda= '$deuda', comentario = '$comentario' WHERE id = $id";
                mysqli_query($conn, $query);

            } else {
                $query = "SELECT nombre FROM clientekm15 where id=$idCliente";
                ...
                $query = "UPDATE bonoskm15 set nombre = '$nombre',valor= '$valor',abono= '$abono',Deuda= '$deuda', comentario = '$comentario',idCliente='$idCliente' WHERE id = $id";
                mysqli_query($conn, $query);
            }
...
<div class="container p-4 shadow editwidth">
    <div class="col-md-8 mx-auto">
        <div class="card_body">
            <h1>Edicion</h1>
            <form action="edit-bonosKm15.php?id=<?php echo $_GET["id"]; ?>" method="post">
