...
if (isset($_GET["id"])) {
    ...
    if (isset($_POST["Abonar"])) {
        ...
        <?php
            ...
            $query = "UPDATE bonoskm15 set deuda= '$deuda',  abono='$nuevoAbono', comentario='$comentario' WHERE ID = $id";
...
<div class="responsive">
    <div class="container p-4 shadow editwidth">
        <div class="col-md-8 mx-auto">
            <div class="card_body">
                <form action="abono-bonosKm15.php?id=<?php echo $_GET["id"]; ?>" method="post">
                    <div class="mb-3">
