    ...
    if (isset($_POST["Abonar"])) {
        ...
        <?php
            ...
            if ($_POST["comentario"] == "") {
                ...
                $comentario = $comentario . " / " . "El " . $DateAndTime . " Abono " . $abono . " pesos--> " . " " . $_POST["comentario"];
            }
            $query = "UPDATE bonos set deuda= '$deuda',  abono='$nuevoAbono', comentario='$comentario' WHERE ID = $id";
...
<div class="responsive">
    <div class="container p-4 shadow editwidth">
        <div class="col-md-8 mx-auto">
            <div class="card_body">
                <form action="abono-bonos.php?id=<?php echo $_GET["id"]; ?>" method="post">
                    <div class="mb-3">
