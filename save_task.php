...
if (isset($_GET["id"])) {
  ...
  if ($id == 1) {
    ...
    $query = "INSERT INTO gas(nombre, galones, precio, abono,deuda,credito,comentario,idCliente) VALUES('$nombre','$galones','$precio','$abono', '$deuda', '$credito','$comentario','$idCliente')";
...
<div class="container p-4 shadow editwidth">
  <div class="col-md-8 mx-auto">
    <div class="card_body">
      <form action="validacionFactura.php?id=1" method="post">
