...
<head>
    ...
    <!-- estilos adicionales -->
    <link href="styles/estilosGuayo.css" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-dark bg-dark shadow width-nav">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">GuayoGas</a>
                ...
                <div class="modal-body">
                    <ul class="list-group list-group-flush">
                        <a href="index.php" class="nav-link">
                            <li class="bg-primary text-white list-group-item itemMenuLateral"><i class="iconos bi bi-file-text-fill"></i> FACTURACION</li>
                        </a>
                        ...
                        <a href="bonos.php" class="nav-link">
                            <li class="list-group-item itemMenuLateral bg-primary text-white"><i class="iconos bi bi-ticket-perferated-fill"></i> BONOS</li>
                        </a>
                        <a href="bonos-cobros.php" class="nav-link">
                            <li class="list-group-item itemMenuLateral bg-primary text-white"><i class="iconos bi bi-calendar-x-fill"></i> BONOS VENCIDOS</li>
                        </a>
                        <a href="clientes.php" class="nav-link">
                            <li class="list-group-item itemMenuLateral bg-primary text-white"><i class="bi bi-person-badge-fill"></i> CLIENTES</li>
                        </a>
