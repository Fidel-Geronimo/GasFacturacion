        ...
        Swal
            ...
            .then(resultado => {
                if (resultado.value) {
                    ...
                    window.location = "https://wa.me/1<?php echo $telefonoClientePago ?>?text=*MENSAJE%20AUTOMATICO%20GUAYO*%0A%0A*FACTURA%20PAGADA:*%0AMensaje%20Dirigido%20A:%20<?php echo $nombreClientePago ?>%0A%0A*FACTURA%20PAGADA EXITOSAMENTE!*%0AGracias%20por%20realizar%20el%20pago%20de%20su%20factura%20de%20Gas%0A%0ARecuerde%20siempre%20pagar%20a%20tiempo%20para%20mantener%20su%20credito%20*VIGENTE*!%0A%0A*GRACIAS%20POR%20PREFERIRNOS*";
...
// mensaje al facturar un cliente
    ...
    <div class="row">
        ...
        if (isset($_SESSION["revertir"])) { ?>
            ...
            <div class="alert alert-primary d-flex align-items-center" role="alert">
                ...
                <div>
                    <button type="button" class="btn" onclick="window.location.href='revertir.php'"><i class="fas fa-sync-alt"></i> Revertir</button>
        ...
        <button type="button" onclick="location.href='save_task.php?id=0'" class="btn btn-primary btn-lg edicionButton"><i class="fas fa-plus"></i> Nueva Factura</button>
